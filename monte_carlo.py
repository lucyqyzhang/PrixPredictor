...
class monte_carlo:
    ...
    def getVariables(self):
        ...
        #resample data into 126 days (half a stock market year)
        prices_ohlc = prices['Adj Close'].resample('126D').ohlc()
    ...
    #https://programmingforfinance.com/2017/11/monte-carlo-simulations-
    #of-future-stock-prices-in-python/
